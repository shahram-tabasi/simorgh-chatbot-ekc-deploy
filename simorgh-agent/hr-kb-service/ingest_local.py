...
CANONICAL_CARDS: List[Dict[str, Any]] = [
    ...
    {"doc_id": "leave", "topic": "leave_all_types",
     ...
     "text": "انواع مرخصی مجاز در شرکت الکتروکویر (سازمان) طبق دستورالعمل مرخصی کد EKWI-AD-006-01 شامل ۱۲ نوع زیر است: "
             "۱) **مرخصی استحقاقی** (۳۰ روز سالانه با احتساب ۴ جمعه، ماده ۶۴ قانون کار) — شامل دو زیرنوع: روزانه و ساعتی. "
             "۲) **مرخصی دوران شیردهی** (حق شیر تا دو سالگی کودک: کارخانه ۰۱:۱۵ روزانه، دفتر تهران ۰۱:۳۰ روزانه، دوقلو ۲ ساعت — ماده ۷۸). "
             "۳) **مرخصی زایمان** (۹ ماه با حقوق از تأمین اجتماعی، ماده ۷۶). "
             ...
             "۶) **مرخصی استعلاجی** (با تأیید پزشک و تأمین اجتماعی، حقوق توسط شرکت پرداخت نمی‌شود، مدت قانونی ندارد). "
             "۷) **مرخصی بدون حقوق** (سقف سالانه ۱ ماه، تا ۷ روز با کمیته منابع انسانی، بیش از آن با مدیرعامل — ماده ۷۲). "
             "۸) **مرخصی حج** (یک ماه با حقوق فقط برای حج تمتع واجب، حج عمره مرخصی بدون حقوق). "
             "۹) **مرخصی تحصیلی** (نوع بدون حقوق، فوق دیپلم ۲ سال، کارشناسی ۴ سال، ارشد ۲ سال، قابل تمدید ۲ سال، با مجوز مدیرعامل، تهاتر با اضافه‌کار). "
             "۱۰) **مجوز خروج** (مرخصی کوتاه‌مدت در ساعات موظفی، حداکثر ۱۰ دقیقه، دو بار در هفته). "
             "۱۱) **بازخرید مرخصی** (در صورت عدم موافقت مدیر، بازخرید مازاد بر اساس جمع کل حقوق؛ مرخصی منفی حداکثر ۳ روز). "
             "۱۲) **سایر مرخصی‌ها** (مسابقات ورزشی و موارد خاص با مجوز مدیران ارشد/مدیرعامل). "
             "مرجع: دستورالعمل مرخصی (EKWI-AD-006-01)، فصل ۵ و ۶.",
     "source_section": "۵. انواع مرخصی در قانون کار + ۶. روش اجرا"},
